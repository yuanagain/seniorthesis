"""
experiment_mintrick1.py
Minimization trick 1
Author: Yuan Wang
"""
...
def main():
    ...
    expmt.setParams(T = 2, start_pt = [1,2,1,-1])
    print("============")
    print(expmt)

    plt = evo.gen_plot( x_0 = [-1.5577701824280878e-05, 0.0013722511573962637, 0.00054429126573123619, -0.0054978258767095466], 
                        T = 1,
                        dt = 0.1,
                        plot_type = 0)
    expmt.savePlot(plt)
